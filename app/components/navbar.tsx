...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* MOBILE MENU (Standard React Conditional Rendering) */}
      <div
        className={`md:hidden bg-[#0a0a0a] border-b border-white/10 overflow-hidden transition-all duration-300 ease-in-out ${
